...
var EBE_FilterManager = function(){
    var formEl = $(".common_normalContent form:eq(0)");
...
var EBE_DeleteManager = function(delSureHandler){
...
var EBE_AppendToShoppingcarManager = function(appendHandler){
...
$(function(){
    new EBE_ModuleGroup();
    new EBE_FilterManager();
    new EBE_DeleteManager(function(orderID){
