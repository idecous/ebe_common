...
var EBE_FormManager = function(){
    ...
    var formEl = $(".normalBlock form");
    var addressRowEl = formEl.find(".addressList");
    var addressInputEl = addressRowEl.find("input");
    var appendAddressBlockEl = formEl.find(".appendAddressBlock");
    addressInputEl.change(addressInputChangeHandler);
    function addressInputChangeHandler(){
        addressInputEl = addressRowEl.find("input:checked");
        if( addressInputEl.length==1 && addressInputEl.val()=="" ){
    ...
    var stepNavEl = formEl.find(".processPanel ");
